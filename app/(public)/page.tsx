...
export default function Home() {
  return (
    <>
      <section>
        <div className="container mx-auto flex flex-col items-center space-y-6 py-16 md:py-24 lg:py-32">
          <Hero
            ...
            primaryCtaLink="https://example.org"
      ...
      <div id="features" />
      <section className="bg-ghost-200 dark:bg-zinc-800">
        <div className="container mx-auto flex flex-col items-center space-y-6 py-4 md:py-8 lg:py-24">
          <FeatureGrid
            title="Features"
